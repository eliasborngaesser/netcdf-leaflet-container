...
curl -L https://raw.githubusercontent.com/eliasborngaesser/netcdf-leaflet-container/%branch%/conf/geoserver/netcdf.projections.properties -o "%folder%\netcdf.projections.properties"
curl -L https://raw.githubusercontent.com/eliasborngaesser/netcdf-leaflet-container/%branch%/conf/geoserver/content.ftl -o "%folder%\content.ftl"
